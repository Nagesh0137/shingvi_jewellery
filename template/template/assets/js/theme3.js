(function($) {
    ...
    var ST = {
        ...
        footerInsta: function() {
            function adjustArrowPosition() {
                var $sliderHeight = $(".insta-wrap .swiper-slide").height(),
                    $buttonHeight = $(".insta-wrap .swiper-buttons button").outerHeight(),
                    $arrowTop = ($sliderHeight / 2) - ($buttonHeight / 2);
                $(".insta-wrap .swiper-buttons button").each(function() {
                    $(this).css("top", $arrowTop + "px");
                });
            }
    ...
    ST.dealSlider = {
        init: function() {
            function adjustArrowPosition() {
                var $sliderHeight = $(".collection-wrap .deal-slider").height(),
                    $buttonHeight = $(".collection-wrap .swiper-buttons button").outerHeight(),
                    $arrowTop = ($sliderHeight / 2) - ($buttonHeight / 2);
                $(".collection-wrap .swiper-buttons button").each(function() {
                    $(this).css("top", $arrowTop + "px");
