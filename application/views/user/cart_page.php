                                            ...
                                            <div class="col-12 col-md-5">
                                                ...
                                                <div class="cart-item-content d-flex flex-wrap">
                                                    <div class="cart-item-image width-88">
                                                        <a href="<?=base_url()?>user/products" class="d-block br-hidden"><img src="<?=base_url()?>u_assets/assets/image/cart/cart-1.jpg" class="w-100 img-fluid" alt="cart-1"></a>
                                                    </div>
                            ...
                            <div class="row row-mtm align-items-lg-start">
                                <div class="col-12 col-lg-8 p-lg-sticky top-0" data-animate="animate__fadeIn">
                                    <div class="cart-summary-button d-flex flex-wrap justify-content-sm-between">
                                        <a href="<?= base_url()?>user/collection" class="width-100 width-sm-auto btn-style quaternary-btn">Continue shopping</a>
                                        <a href="<?= base_url()?>user/cart_empty" class="width-100 width-sm-auto btn-style secondary-btn mst-15 mst-sm-0">Clear cart</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="single-product w-100">
                                        <div class="row single-product-wrap">
                                            <div class="product-image">
                                                ...
                                                <div class="product-action">
                                                    <a href="<?= base_url()?>user/wishlists" class="wishlist">
                                                        <span class="product-icon">Wishlist</span>
                                                    </a>
                                                    <a href="#quickview-modal" data-bs-toggle="modal" class="quick-view">
                                                        <span class="product-icon">Quickview</span>
