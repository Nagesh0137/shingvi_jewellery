                ...
                <div class="col-12 col-lg-8 col-xl-9 p-lg-sticky top-0">
                    <div class="ap-detail">
                       <form action="<?= base_url() ?>user/update_user_details" method="post" enctype="multipart/form-data">
                            ...
                            <div class="acc-detail-form">
                              <div class="acc-detail-field">
                                <div class="row field-row">
                                    <input type="hidden" name="profile_photo1" value="<?=$customer_details[0]['profile_photo']?>">
                                    <input type="hidden" name="customers_id" value="<?=$customer_details[0]['customers_id']?>">
                                    ...
                                    <div class="col-12 col-md-6 field-col">
                                      ...
                                      <input type="text" id="fname" name="firstname" class="w-100" placeholder="First name" autocomplete="given-name" value="<?=$customer_details[0]['firstname']?>">
                                  </div>
                                  ...
                                  <input type="text" id="lname" name="lastname" class="w-100" placeholder="Last name" autocomplete="family-name" value="<?=$customer_details[0]['lastname']?>">
                              </div>
                              ...
                              <input type="tel" id="mobile" name="mobile" class="w-100" placeholder="Mobile number" autocomplete="tel" value="<?=$customer_details[0]['mobile']?>">
                          </div>
                          ...
                          <input type="email" id="email" name="email" class="w-100" placeholder="Email address" autocomplete="email" value="<?=$customer_details[0]['email']?>">
                      </div>
