        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mt-5 mb-5">
                    <div class="categories__sidebar bg-white p-4">
                        <h3 class="mb-4 pb-2 border-bottom">Our Categories</h3>
                        <div class="row">
                            <?php if(count($category) > 0): ?>
                                <?php foreach($category as $row): ?>
                                    <div class="col-6 col-md-12 mb-3">
                                        <a href="<?= strtolower($row['category_name']) == 'gift' ? base_url().'user/show_product_details?label=Gift' : base_url().'user/show_product_details?cat_id='.$row['category_id'] ?>" 
                                           class="category__link d-flex align-items-center p-2 rounded">
                                            <img src="<?= base_url() ?>uploads/<?= $row['category_image'] ?>" 
