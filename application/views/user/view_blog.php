...
<main class="main__content_wrapper">
    ...
    <div class="breadcrumb-area ptb-15" data-bgimg="<?= base_url() ?>u_assets/assets/image/other/breadcrumb-bgimg.jpg">
        <div class="container">
            <span class="d-block extra-color"><a href="<?= base_url() ?>" class="extra-color">Home</a> / View
                Blog</span>
        </div>
    </div>
    ...
    <section class="blog__details--section section--padding mt-5 mb-5">
        <div class="container">
            <div class="row">
                    ...
                    <div class="blog__details--wrapper">
                        ...
                        <div class="blog__details--media mb-5">
                            <?php if ($blog_det[0]['blog_type'] == 'Image'): ?>
                                <img src="<?= base_url() ?>uploads/<?= $blog_det[0]['blog_image'] ?>"
                                    alt="<?= $blog_det[0]['blog_label'] ?>" class="img-fluid rounded-3 w-100">
                            <?php else: ?>
                                <div class="ratio ratio-16x9">
                                    <video controls class="rounded-3">
                                        <source src="<?= base_url() ?>uploads/<?= $blog_det[0]['blog_image'] ?>"
                                            type="video/mp4">
                        ...
                        <div class="blog__details--content">
                            ...
                            <div class="blog__details--meta mb-4">
                                <span class="text-muted"><i class="bi bi-person-fill"></i>
                                    <?= $blog_det[0]['blog_by'] ?></span>
                                <span class="text-muted ms-3"><i class="bi bi-calendar"></i>
                                    <?= isset($blog_det[0]['entry_time']) ? date('d M Y', $blog_det[0]['entry_time']) : '' ?></span>
                            </div>
                        ...
                        <?php if (count($blog_comments) > 0): ?>
                            <div class="blog__comments--section mt-5 mb-5 pt-5">
                                ...
                                <div class="blog__comments--list">
                                    <?php foreach ($blog_comments as $key => $row) { ?>
                                        <div class="blog__comment--item mb-4">
                                            <div class="card border-0 shadow-sm">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <h5 class="mb-0"><i class="bi bi-person-circle me-2"></i>
                                                            <?= $row['author'] ?></h5>
                                                        <small
                                                            class="text-muted"><?= date('d M Y', $row['entry_time']) ?></small>
                                                    </div>
                ...
                <div class="col-lg-4">
                    <!-- Comment form -->
                    <div class="blog__comment--form mb-5" style="top: 20px;">
                        <div class="card shadow-sm border-0">
                            <div class="card-body p-4">
                                ...
                                <form action="<?= base_url() ?>user/save_blog_comment" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="author" class="form-label">Name <span
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="mobile" name="mobile"
                                            value="<?= (isset($user_det['mobile'])) ? $user_det['mobile'] : '' ?>"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <button type="submit" style="background-color: #9c1137;"
                                        class="btn text-white btn-sm float-end">Submit
                                        Comment</button>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <a href="<?= base_url() ?>user/view_blog/<?= $row['web_blog_id'] ?>">
                                        <?php if ($row['blog_type'] == "Image"): ?>
                                            <img src="<?= base_url() ?>uploads/<?= $row['blog_image'] ?>"
                                                alt="<?= $row['blog_label'] ?>" class="img-fluid w-100">
                                        <?php else: ?>
                                            <div class="ratio ratio-16x9">
                                                <video class="w-100">
