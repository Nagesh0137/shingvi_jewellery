        ...
        <div class="container">
            ...
            <div class="contact__wrapper">
                ...
                <div class="contact__form--wrapper">
                    ...
                    <form class="contact__form" action="<?= base_url() ?>user/save_contact_form" method="post"
                        ...
                        <div class="form__row">
                            <div class="form__group">
                                ...
                                <input type="tel" name="mobile" id="mobile" placeholder="Phone number"
                                    value="<?= isset($user_det['firstname']) ? $user_det['mobile'] : '' ?>" required
                            ...
                            <div class="form__group">
                                ...
                                <input type="email" name="email" id="email" placeholder="Email"
                                    value="<?= isset($user_det['firstname']) ? $user_det['email'] : '' ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form__group">
                            ...
                            <textarea name="enquiry" id="enquiry" placeholder="Write your message here..." required
                    ...
                    <div class="contact__info--item">
                        ...
                        <div class="contact__content">
                            ...
                            <div class="social__links">
                                <a href="https://www.facebook.com/shingavijewellerspvtltd/" target="_blank"
                                    class="social__link">
                                    <i class="ri-facebook-fill"></i>
                                </a>
                                <a href="http://pinterest.com/pin/create/button/?url=<?= urlencode((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]") ?>"
                                    target="_blank" class="social__link">
                                    <i class="ri-pinterest-fill"></i>
                                </a>
                                <a href="https://www.instagram.com/shingavijewellers/" target="_blank"
                                    class="social__link">
                                    <i class="ri-instagram-fill"></i>
                                </a>
                                <a href="https://wa.me/?text=<?= urlencode((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]") ?>"
                                    target="_blank" class="social__link">
            ...
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="map__wrapper">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15079.099066565494!2d74.7176940554199!3d19.117534400000018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdcba80e92dceb9%3A0xb4508942ab098a3!2sShingavi%20Jewellers%20Pvt.Ltd.!5e0!3m2!1sen!2sin!4v1729669055869!5m2!1sen!2sin"
                ...
                <div class="col-md-6">
                    <div class="map__wrapper">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.2983871405077!2d74.73721577583804!3d19.094561451388383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdcb066ccf6dc79%3A0x1f57efbfb6863cb1!2s3155%2C%20Juna%20Kapad%20Bazaar%20Rd%2C%20Nalegaon%2C%20Ahmadnagar%2C%20Maharashtra%20414001!5e0!3m2!1sen!2sin!4v1747893669115!5m2!1sen!2sin"
                            allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
...
<style>
    ...
    .contact__info--wrapper {
        ...
        min-width: 300px;
        background: #f7f4ef;
        /* Light and attractive background */
        padding: 40px;
        border-radius: 10px;
        color: #333;
    ...
    .contact__icon {
        ...
        height: 50px;
        background: #b32726;
        /* softer background for icon circle */
        border-radius: 50%;
        display: flex;
        align-items: center;
    ...
    .contact__icon svg {
        ...
        height: 24px;
        color: white;
        /* deep jewel red for icons – you can change to gold (#c9a96b) or gray (#333) */
    }
    ...
    .contact__content p {
        color: #555;
        /* Slightly dark text for readability */
    }
    ...
    .social__link {
        color: #b32726;
        /* Stylish red, consistent with brand tone */
    }
