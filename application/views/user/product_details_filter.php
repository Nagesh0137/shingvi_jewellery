                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="shop-sidebar-wrap shop-filter-sidebar" data-animate="animate__fadeIn">
                                ...
                                <ul class="widget__categories--menu mt-3" style="height: 140px;overflow-y: auto;">
                                <li class="widget__categories--menu__list ">
                                <a href="<?=base_url()?>user/product_details_filter" class="bg-white d-flex mb-2 align-items-center p-2 text-dark text-center justify-content-center<?php if(!isset($_GET['g_id'])){echo ' secondary-bg ';} ?>" style="cursor: pointer;">All</a>
                                </li>
                                    <?php
                                    foreach($product_group as $key=>$row1){
                                    ?>
                                    <li class="widget__categories--menu__list ">
                                                <a href="<?=base_url()?>user/product_details_filter?g_id=<?=$row1['product_group_id']?>" style="cursor: pointer;">

                                                    <label class="bg-white d-flex align-items-center p-2 text-center justify-content-center" style="margin-bottom: 10px;cursor: pointer;">
                                    ...
                                    <div class="row mt-4">
                                        <h6>Jewellery For</h6>
                                        <div class="col-md-12">
                                        <select name="age_category" style="font-size:14px;height:40px;" class="form-select form-control mt-3">
                                                 <option <?= (isset($_GET['age_category']) && ($_GET['age_category'] == 'all')) ? 'selected' : '';?> value='all'>ALL</option>
                                                 <option <?= (isset($_GET['age_category']) && ($_GET['age_category'] == 'women')) ? 'selected' : '';?> value="women">Women</option>
                                                 <option <?= (isset($_GET['age_category']) && ($_GET['age_category'] == 'men')) ? 'selected' : '';?> value="men">Men</option>
                                                 <option <?= (isset($_GET['age_category']) && ($_GET['age_category'] == 'kids')) ? 'selected' : '';?> value="kids">Kid's</option>
                                             </select>
                                        </div>
                                    </div>
                                    <div class="shop-sidebar price">
                                        ...
                                        <div class="shop-header d-flex justify-content-between mst-22">
                                            <span class="shop-selected">The highest price </span>
