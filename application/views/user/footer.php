                                    ...
                                    <form method="post" class="news-form mst-13">
                                        ...
                                        <div class="mst-11">
                                            <label class="cust-checkbox-label checkbox-agree">
                                                ...
                                                <span class="login-read">I agree with the <a href="<?=base_url()?>rohan/terms_of_use" class="body-secondary-color text-decoration-underline">terms & conditions</a>.</span>
                                            </label>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="footer-menu">
                                        ...
                                        <div class="ft-link collapse" id="collapse-top-category">
                                            <ul class="ftlink-ul ul-ft pst-21 peb-1 peb-md-0">
                                                <li class="ftlink-li">
                                                    <a href="<?=base_url()?>" class="d-inline-block body-dominant-color">Rings</a>
                                                </li>
                                                <li class="ftlink-li">
                                                    <a href="<?=base_url()?>" class="d-inline-block body-dominant-color">Earrings</a>
                                                </li>
                                                <li class="ftlink-li">
                                                    <a href="<?=base_url()?>" class="d-inline-block body-dominant-color">Necklace</a>
                                                </li>
                                                <li class="ftlink-li">
                                                    <a href="<?=base_url()?>" class="d-inline-block body-dominant-color">Bracelet</a>
                                                </li>
                                                <li class="ftlink-li">
                                                    <a href="<?=base_url()?>" class="d-inline-block body-dominant-color">Anklets</a>
                                                </li>
                                                <li class="ftlink-li">
                ...
                <ul class="menu-ul beb">
                    <li class="menu-li bst">
                        <div class="menu-btn d-flex flex-row-reverse">
                            ...
                            <span class="width-calc-48 ptb-10 plr-15"><a href="<?= base_url() ?>" class="d-inline-block body-color">Home</a></span>
                        </div>
                    ...
                    <li class="menu-li bst">
                        ...
                        <div class="menu-dropdown collapse" id="menu-product">
                            <ul class="menudrop-ul">
                                <li class="menudrop-li bst">
                                    <span class="d-block ptb-10 psl-20 per-15"><a href="<?= base_url() ?>user/products" class="d-inline-block body-color">Products Page</a></span>
                                </li>
                    ...
                    <li class="menu-li bst">
                        <div class="menu-btn d-flex flex-row-reverse">
                            ...
                            <span class="width-calc-48 ptb-10 plr-15"><a href="<?=base_url()?>" class="d-inline-block body-color">Shop</a></span>
                        </div>
                            ...
                            <ul class="menudrop-ul">
                                ...
                                <li class="menudrop-li bst">
                                    ...
                                    <div class="menusub-dropdown collapse" id="menu-order">
                                        <ul class="menusub-ul">
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="<?=base_url()?>" class="d-inline-block body-color">Order complete</a></span>
                                            </li>
                                            <li class="menusub-li bst">
                                ...
                                <li class="menudrop-li bst">
                                    ...
                                    <div class="menusub-dropdown collapse" id="menu-policies">
                                        <ul class="menusub-ul">
                                            ...
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="<?=base_url()?>rohan/terms_of_use" class="d-inline-block body-color">Terms & condition</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <li class="menu-li bst">
                        ...
                        <div class="menu-dropdown collapse" id="menu-blog">
                            <ul class="menudrop-ul">
                                <li class="menudrop-li bst">
                                    <span class="d-block ptb-10 psl-20 per-15"><a href="<?= base_url() ?>user/blog" class="d-inline-block body-color">Blog Page</a></span>
                                </li>
                    ...
                    <li class="menu-li bst">
                        <div class="menu-btn d-flex flex-row-reverse">
                            ...
                            <span class="width-calc-48 ptb-10 plr-15"><a href="javascript:void(0)" class="d-inline-block">Page</a></span>
                        </div>
                        <div class="menu-dropdown collapse" id="menu-page">
                            <ul class="menudrop-ul">
                                <li class="menudrop-li bst">
                                    <div class="menu-btn d-flex flex-row-reverse">
                                        <button type="button" class="width-48 icon-16 ptb-10 bsl" data-bs-toggle="collapse" data-bs-target="#menu-aboutus" aria-expanded="false" aria-label="Menu accordion"><i class="ri-add-line d-block lh-1"></i></button>
                                        <span class="width-calc-48 ptb-10 psl-20 per-15"><a href="javascript:void(0)" class="d-inline-block">About us</a></span>
                                    </div>
                                    <div class="menusub-dropdown collapse" id="menu-aboutus">
                                        <ul class="menusub-ul">
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="about-us.html" class="d-inline-block body-color">01 Clean aboutus</a></span>
                                            </li>
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="about-us2.html" class="d-inline-block body-color">02 Standard aboutus</a></span>
                                            </li>
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="about-us3.html" class="d-inline-block body-color">02 Classic aboutus</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="menudrop-li bst">
                                    <div class="menu-btn d-flex flex-row-reverse">
                                        <button type="button" class="width-48 icon-16 ptb-10 bsl" data-bs-toggle="collapse" data-bs-target="#menu-contactus" aria-expanded="false" aria-label="Menu accordion"><i class="ri-add-line d-block lh-1"></i></button>
                                        <span class="width-calc-48 ptb-10 psl-20 per-15"><a href="javascript:void(0)" class="d-inline-block">Contact us</a></span>
                                    </div>
                                    <div class="menusub-dropdown collapse" id="menu-contactus">
                                        <ul class="menusub-ul">
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="contact-us.html" class="d-inline-block body-color">01 Simple contactus</a></span>
                                            </li>
                                            <li class="menusub-li bst">
                                                <span class="d-block ptb-10 psl-25 per-15"><a href="contact-us2.html" class="d-inline-block body-color">02 Minimalist contactus</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="menudrop-li bst">
                                    <span class="d-block ptb-10 psl-20 per-15"><a href="<?= base_url() ?>user/faq" class="d-inline-block body-color">Faqs</a></span>
                                </li>
                                <li class="menudrop-li bst">
                                ...
                                <li class="menudrop-li bst">
                                    <div class="menu-btn d-flex flex-row-reverse">
                                        ...
                                        <span class="width-calc-48 ptb-10 psl-20 per-15"><a href="javascript:void(0)" class="d-inline-block">Wishlist</a></span>
                                    </div>
            ...
            <div class="mobile-cl bst">
                <div class="d-flex">
                    <div class="col-6">
                        <div class="local-cl">
                            <form method="post" action="JavaScript:void(0)" class="localization-form" enctype="multipart/form-data">
                                <button type="submit" class="mobile-cl-btn w-100 body-color d-flex align-items-center justify-content-between ptb-10 plr-15 beb">English<i class="ri-arrow-down-s-line d-block icon-16 lh-1"></i></button>
                                <div class="local-cl-drodown-menu position-absolute bottom-0 start-0 end-0 body-bg z-1 bst">
                                    <button type="button" class="mobile-cl-close-btn d-block w-100 heading-color ptb-10 plr-15" aria-label="Currency / Language menu close">Close</button>
                                    <ul>
                                        <li class="active bst"><a href="javascript:void(0)" class="d-block ptb-10 plr-15">English</a></li>
                                        <li class="bst"><a href="javascript:void(0)" class="d-block ptb-10 plr-15">Spanish</a></li>
                                        <li class="bst"><a href="javascript:void(0)" class="d-block ptb-10 plr-15">French</a></li>
                                    </ul>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-6 bsl">
                        <div class="local-cl">
                            <form method="post" action="JavaScript:void(0)" class="localization-form" enctype="multipart/form-data">
                                <button type="submit" class="mobile-cl-btn w-100 body-color d-flex align-items-center justify-content-between ptb-10 plr-15 beb">USD $<i class="ri-arrow-down-s-line d-block icon-16 lh-1"></i></button>
                                <div class="local-cl-drodown-menu position-absolute bottom-0 start-0 end-0 body-bg z-1 bst">
                                    <button type="button" class="mobile-cl-close-btn d-block w-100 heading-color ptb-10 plr-15" aria-label="Currency / Language menu close">Close</button>
                                    <ul>
                                        <li class="active bst"><a href="javascript:void(0)" class="d-block ptb-10 plr-15">USD $</a></li>
                                        <li class="bst"><a href="javascript:void(0)" class="d-block ptb-10 plr-15">EUR €</a></li>
                                        <li class="bst"><a href="javascript:void(0)" class="d-block ptb-10 plr-15">INR ₹</a></li>
                                    </ul>
                                </div>
                            </form>
                        </div>
