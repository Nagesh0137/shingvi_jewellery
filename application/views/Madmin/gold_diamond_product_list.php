    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between form-heading p-2 mb-4" style="margin-top:-10px">
                <h4 class="mb-sm-0 font-size-18">Gold + Diamond Product List</h4>
            </div>
        </div>
    </div>
		<div class="col-md-12">
            <div class="card">
                <div class="card-body">
                <form action="<?=base_url();?>madmin/search_gold_diamond_product_list" method="get">
		...
		<div class="col-md-12">
            <div class="card">
                <div class="card-body">
                   ...
                   <table class="table table-striped mt-3 table-sm table-bordered cat_table mb-5">
						<thead>
							<tr>
						...
						<tbody>
							...
							$i=0;
								...
								$i++;
								if(trim($group_cat[0]['category_name'])=="Diamond"){
								?>
										<tr style="<?=($row2['label']=='Out Of Stock') ? 'background: red;color: white;':''?> ">
											<td style="font-size: 16px;">
												<a href="<?=base_url();?>Madmin/gold_diamond_product_list_View/<?=$row2['prod_gold_id'];?>" class="btn btn-success pl-1 pr-1 pt-0 pb-0 mb-1"><i class="fa fa-print"></i></a>

												<!-- <a href="<?=base_url();?>Madmin/gold_diamond_product_list_update/<?=$row2['prod_gold_id'];?>" class="btn btn-primary pl-1 pr-1 pt-0 pb-0 mb-1"><i class="fa fa-edit"></i></a> -->
												

												<a href="<?=base_url();?>Madmin/gold_diamond_product_list_delete/<?=$row2['prod_gold_id'];?>" onclick="return confirm('Are You Sure...')" class="btn btn-danger pl-1 pr-1 pt-0 pb-0 mb-1"><i class="fa fa-trash"></i></a> 
											</td>
											...
											<td>
												<?=number_format($madmin->golddiamondprice($row2['prod_gold_id']));?>
											</td>
											<td>
											...
											<td>
												...
												?>
												<a href="<?=base_url();?>uploads/<?=$aa[0];?>" target="blank">
													<img src="<?=base_url();?>uploads/<?=$aa[0];?>" style="height:100px;width:100px;object-fit:cover">
												</a>
											</td>
										</tr>
									<?php
