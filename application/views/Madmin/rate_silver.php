<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <form action="<?=base_url()?>Madmin/silver_rate_add" method="post" enctype="multipart/form-data" id="form1">
                        
                        <div class="mb-3">
                            <label for="formrow-firstname-input" class="form-label">Enter Todays Rate(10g)</label>
                            <input type="text" name="silver_amt" id="silver_amt" placeholder="Todays Price" required class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" >
                        </div>
                    ...
                    <form action="<?=base_url()?>Madmin/silver_rate_update" method="post" enctype="multipart/form-data" id="form2">
                        <div class="mb-3">
                            <label for="formrow-firstname-input" class="form-label">Enter Todays Rate(10g)</label>
                            <input type="text" name="silver_amt" id="silver_amt1" placeholder="Todays Price" required  class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" style="width:480px">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="formrow-email-input" class="form-label">Enter Todays Rate Date</label>
                                    <input type="hidden" name="rate_silver_id" id="rate_silver_id1" required class="form-control">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <form style="border-bottom:1px solid black;" action="<?=base_url()?>Madmin/silver_rate_search" method="get" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="mb-3">
                            ...
                            <tbody>
                                <?php $i=1; foreach ($rate as $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <button class="btn btn-outline-primary py-1 px-2" onclick="updatesilver('<?=$value['rate_silver_id'];?>','<?=$value['ratedate'];?>','<?=$value['ratetime'];?>','<?=$value['silver_amt'];?>','<?php if(isset($search['from_date'])){echo $search['from_date'];}?>','<?php if(isset($search['to_date'])){echo $search['to_date'];}?>')"><i class="fa fa-edit"></i></button> -->

                                            <a href="<?= base_url() ?>Madmin/edit_silver_rate/<?= $value['rate_silver_id'] ?>" class="btn btn-outline-primary py-1 px-2" ><i class="fa fa-edit"></i></a>

                                            <a onclick="return confirm('Are You Sure to permanant Delete this data...')" href="<?=base_url();?>Madmin/silver_rate_delete/<?=$value['rate_silver_id'];?><?php if(isset($search['from_date'])){echo "/".$search['from_date'];}?><?php if(isset($search['to_date'])){echo "/".$search['to_date'];}?>" class="btn btn-outline-danger py-1 px-2"><i class="fa fa-trash"></i></a>
