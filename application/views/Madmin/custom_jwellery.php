                    ...
                    <table class="table table-sm text-center table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td>
                                            <a href="<?= base_url() ?>Madmin/custom_jwellery_view/<?= $row['custom_jwellery_id'] ?>"><button class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</button></a>
                                        </td>
                                        <td><?= ++$i ?></td>
                                        <td><?= $row['name']; ?></td>
                                        ...
                                        <td><?= $row['address']; ?></td>
                                        <td><?= $row['budget']; ?>&#8377;/-</td>
                                        <td> <?= date("d-M-Y h:i A", $row['date_time']); ?></td>
                                    </tr>
                                <?php
                                }
                            } else {
