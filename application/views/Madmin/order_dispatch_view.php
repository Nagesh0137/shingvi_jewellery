            ...
            <div class="row d-flex justify-content-between align-items-center">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between form-heading p-2 mb-4" style="margin-top:-10px">
                        <h4 class="mb-sm-0 font-size-18">Dispatched Order</h4>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        if(isset($order_details[0]['billing_id'])){
                            ...
                            <div class="col-md-12 text-center" style="margin-top: 10px;">
                                <a href="<?=base_url();?>Madmin/order_shift_in_delivered?id=<?=$order_details[0]['billing_id'];?>"><button class="btn btn-primary btn-lg">SHIFT ORDER IN DELIVERED</button></a>
                            </div>
                            <?php
                        }
                        ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <!-- <button type="button model-close" class="close" data-dismiss="modal" aria-label="Close">
