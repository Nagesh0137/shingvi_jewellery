<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-body border-bottom">
                    <form action="<?=base_url()?>Madmin/branch_details_save" method="post" enctype="multipart/form-data" id="form1">
                        ...
                        <div class="col-xxl-4 col-lg-4">
                            ...
                            <textarea  name="branch_address" class="form-control" rows="4" placeholder="Enter Branch Address"></textarea>
                        </div>
                        <div class="col-xxl-4 col-lg-4">
                            <label for="blog_desc">Branch Location</label>
                            <textarea name="branch_location" class="form-control" rows="4" placeholder="Enter Blog Description"></textarea>
                        </div>
                    ...
                    <input type="hidden" name="branch_id" id="branch_id" class="form-control" required>
                        ...
                        <div class="col-xxl-4 col-lg-4">
                            <label for="blog_desc">Branch Address</label>
                            <textarea  name="branch_address" id="branch_address" class="form-control" rows="4" placeholder="Enter Branch Address"></textarea>
                        </div>
                        <div class="col-xxl-4 col-lg-4">
                            <label for="blog_desc">Branch Location</label>
                            <textarea name="branch_location" id="branch_location" class="form-control" rows="4" placeholder="Enter Blog Description"></textarea>
                        </div>
                        <div class="col-md-12 text-center">
            ...
            max-width: 200px; /* Set the max-width for the td element */
        }
