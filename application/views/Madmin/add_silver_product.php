<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url() ?>Madmin/add_new_silver_product" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <select name="group_id" class="form-select" onchange="getSelectedGroup(this)" id="group_id" required>
                            ...
                            <script>
                                function getSelectedGroup(selectElement) {
                                    ...
                                    const ringSizeDiv = document.getElementById('ringSizeDiv');
                                    const sizeGuideDiv = document.getElementById('sizeGuideDiv');

                                    if (selectedText === 'FINGER RING') {
                                        chartDiv.style.display = 'block';
                                        ringSizeDiv.style.display = 'block';
                                        sizeGuideDiv.style.display = 'block';
                                    } else {
                                ...
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    if (selectEl && selectEl.value) {
                                        getSelectedGroup(selectEl);
                                    }
                                });
                            </script>
                            <div class="col-md-3 mt-2 d-none">
                                <b class="form-label">Filter Title</b>
                                <select name="filter_title" class="form-select" onchange="filtername(this)" id="filter_title_id">
                            ...
                            <div class="col-md-7 mt-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3" id="ringSizeDiv">
                                    ...
                                    <div class="col-md-12 mt-3" id="sizeGuideDiv">
                                        ...
                                        <table class="w-100">
                                            ...
                                            <tbody id="add_tbody">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="" onclick="add_row()"><i class="fa fa-plus"></i></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="col-md-5 mt-3" id="fixedbilling" style="border-right: 1px solid black;border-left: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 15px;">
                                ...
                                <div class="row mt-1 pt-2 pb-2 bg-warning" style="border-top:1px solid grey;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12 p-0 m-0">
                                            <input type="text" name="total_discount_amt" onkeyup="fixed_billing_cal()" id="total_discount_amt" value="0" class="bg-success chartinput">
                                            <span class="chartspan">₹</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-1 pt-2 pb-2 bg-warning" style="border-top:1px solid grey;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12 p-0 m-0">
                                            <input type="text" name="final_amount_after_discount" id="final_amount_after_discount" class="bg-info chartinput" value="0" readonly>
                                            <span class="chartspan">₹</span>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    function group_name(cat) {
        $.ajax({
            ...
            // Reset visibility when groups are reloaded
            const chartDiv = document.getElementById('chartUploadDiv');
            const ringSizeDiv = document.getElementById('ringSizeDiv');
            const sizeGuideDiv = document.getElementById('sizeGuideDiv');
    ...
    function filtertitle(group) {
        ...
        $.ajax({
            url: "<?= base_url() ?>madmin/s_filter_title_fetch",
            type: 'POST',
            data: {
                cat_id: cat,
    ...
    function filtername(title) {
        ...
        $.ajax({
            url: "<?= base_url() ?>madmin/s_filter_name_fetch",
            type: 'POST',
            data: {
                cat_id: cat,
                group_id: group_id1,
