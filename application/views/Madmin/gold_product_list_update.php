			...
			$group_id=$this->My_model->select_where('product_group',array('status'=>'active'));
             ...
             <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                        <form action="<?=base_url();?>Madmin/gold_product_list_update_information" method="post">
                            <div class="row">
                        ...
                        <form action="<?= base_url(); ?>Madmin/gold_product_list_update_images" method="post" enctype="multipart/form-data">
                            <div class="row">
                        ...
                        <form action="<?=base_url();?>Madmin/gold_product_list_update_new_images" method="post" enctype="multipart/form-data">
                            <div class="row" style="border-bottom:2px solid black;border-top:2px solid black; padding:10px 0px 10px 0px;margin-top:10px;">
                                <div class="col-md-12 mt-2">
                                    <h4 class="font-weight-bold text-primary text-uppercase">Add New Images :-</h4>
                                    <input type="hidden" name="prod_gold_id" value="<?=$value['prod_gold_id'];?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 mt-3"  style="border-right: 1px solid black;border-left: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 15px;padding-bottom: 15px;">
                            <form action="<?=base_url();?>Madmin/gold_product_list_update_billing" method="post" enctype="multipart/form-data">
