                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="formrow-password-input" class="form-label">Newslater Description</label>
                                        <textarea id="ckeditor" name="newlater_description" placeholder="Enter Newslater Description" id="" class="form-control"><?= $newslater_details[0]['newlater_description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
