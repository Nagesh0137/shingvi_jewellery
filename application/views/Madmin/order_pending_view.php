<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-9 pr-0">
				...
				<tr style="background-color: lightgreen;">
					<td colspan="6" class="fbold text-right" style="font-size: 20px;color: darkred;font-weight: bold;">
						<span class="float-left" style="font-size: 13px;line-height: 100%;text-align: left;">
							<?=($order[0]['payment_mode'] == "online" ) ? 'T.ID : '.$order[0]['tracking_id']." <br> O-ID : ".$order[0]['order_id']:'CASH ON DELIVERY' ?>		
						</span>
					Received Amount</td>
			...
			<div class="row">
				<div class="col-md-12">
					<b style="color: black;" class="h4">ORDER DETAILS</b>
					<table class="table table-sm">
						<tr style="background-color: pink;">
							<th style="font-weight: bold;color: black;font-size: 20px;" width="25%">
								ORDER&nbsp;DATE
							</th>
		...
		<?php
		if(isset($order_details[0]['billing_id'])){
			?>
			<div class="col-md-12 text-center" style="margin-top: 10px;">
				<!-- <a href="<?=base_url();?>madmin/order_shift_in_processing?id=<?=$order_details[0]['billing_id'];?>"> -->
					<button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#shift_order_modal">SHIFT ORDER IN PROCESSING</button>
				<!-- </a> -->
				
				<a href="<?=base_url();?>Madmin/order_cancel_save?id=<?=$order_details[0]['billing_id'];?>"><button class="btn btn-danger btn-lg">REJECT ORDER</button></a>
			</div>
			<?php
		}
		?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="image_modal">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-around align-items-center" id="image_modal_body">
...
if(isset($order_details[0]['billing_id'])){
	?>
	<form action="<?=base_url();?>Madmin/order_shift_in_processing" method="post">
		<input type="text" name="billing_id" value="<?=$order_details[0]['billing_id'];?>" hidden>
		<div class="modal" id="shift_order_modal">
		<div class="modal-dialog">
			<div class="modal-content">

			<!-- Modal Header -->
			<div class="modal-header">
				<h4 class="modal-title" style="color: black;">Shift Order In Processing</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>

			<!-- Modal body -->
			<div class="modal-body" style="color: black;">
				<label>ENTER SYSTEM BILL NO.</label>
				<input type="text" name="system_bill_number" placeholder="ENTER SYSTEM BILL NUMBER" class="form-control" required="" minlength="3">
			</div>

			<!-- Modal footer -->
			<div class="modal-footer">
				<button class="btn btn-primary" >ACCEPT AND PROCESS ORDER</button>
			</div>
