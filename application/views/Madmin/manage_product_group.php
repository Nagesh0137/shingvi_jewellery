<div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    ?>
                        <form action="<?= base_url() ?>Madmin/update_new_product_group" method="post" enctype="multipart/form-data">
    ...
    if (file) {
        ...
        img.src = URL.createObjectURL(file);
                    ...
                    ?>
                        <form action="<?= base_url() ?>Madmin/add_new_product_group" method="post" enctype="multipart/form-data" onsubmit="return validateImage('productGroupImageAdd')">
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    <label class="form-label">Enter Category Name</label>
                                    <select name="group_category" class="form-select" required>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div class="d-flex flex-wrap gap-2">
                                <?php foreach ($group_category as  $value) { ?>
                                    <a href="<?= base_url(); ?>Madmin/manage_product_group/<?= $value['category_id']; ?>" class="btn btn-primary">
                                        <?= $value['category_name']; ?>
                                    </a>
                                <?php } ?>
                            </div>
                            <form action="<?= base_url() ?>Madmin/manage_product_group" method="get">
                                <div class="col-sm-12">
                            ...
                            <table class="table table-bordered text-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url() ?>Madmin/edit_product_group/<?= $row['product_group_id'] ?>" class="btn btn-primary btn-sm p-0 m-0 py-0 px-0" style="height:3vh;width:3vh">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="<?= base_url() ?>Madmin/delete_product_group/<?= $row['product_group_id'] ?>" onclick="return confirm('Are You Sure to delete permanant data ?');" class="btn btn-danger btn-sm p-0 m-0 py-0 px-0" style="height:3vh;width:3vh">
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>Madmin/deactivate_product_group/<?= $row['product_group_id'] ?>"><button class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure To Disable These Product ?....')">Disable</button></a>
                                                </td>
                                                <td><?= ++$i ?></td>
                                    ...
                                    ?>
                                        <tr>
                                            <td style="font-size: 20px;">
                                                <a href="<?= base_url() ?>Madmin/edit_product_group/<?= $row['product_group_id'] ?>" class="btn btn-primary btn-sm p-0 m-0 " style="height:3vh;width:3vh">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="<?= base_url() ?>Madmin/delete_product_group/<?= $row['product_group_id'] ?>" onclick="return confirm('Are You Sure to delete permanant data ?');" class="btn btn-danger p-0 m-0 btn-sm" style="height:3vh;width:3vh">
                                                    <i class="fa fa-trash"></i>
                                                </a>


                                            </td>
                                            <td><a href="<?= base_url() ?>Madmin/activate_product_group/<?= $row['product_group_id'] ?>"><button class="btn btn-sm btn-success" onclick="return confirm('Are You Sure To Active These Product ?....')">Activate</button></a></td>
                                            <td><?= ++$i ?></td>
                                            <td><?= $row['product_group_name'] ?></td>
                                            <td><?= $cat['category_name'] ?></td>
                                            <td>
