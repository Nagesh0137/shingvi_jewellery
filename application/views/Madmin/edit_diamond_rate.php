        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?=base_url()?>Madmin/diamond_rate_update" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="rate_diamond_id" value="<?= $diamond_rate[0]['rate_diamond_id'] ?>" id="">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                <label for="formrow-firstname-input" class="form-label">Enter Todays Rate(10g)</label>
                                <input type="text" name="diamond_amt" id="diamond_amt1" placeholder="Todays Price" required  class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?= $diamond_rate[0]['diamond_amt'] ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="ratedate" id="ratedate1" required class="form-control" value="<?= $diamond_rate[0]['ratedate'] ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="formrow-password-input" class="form-label">Enter Todays Rate Time</label>
                                    <input type="time" name="ratetime" id="ratetime1"  required class="form-control" value="<?= $diamond_rate[0]['ratetime'] ?>">
                                </div>
                            </div>
                        </div>
                        <div>
