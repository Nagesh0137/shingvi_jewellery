            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="<?= base_url() ?>Madmin/social_media" key="t-full-calendar">Social Media</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="<?= base_url() ?>Madmin/order_processing" key="t-product-detail">Processing Order</a></li>
                        ...
                        <li><a href="<?= base_url() ?>Madmin/order_rejected" key="t-cart">Rejeted Orders</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
