              ...
              <tbody>
                ...
                ?>
                    <tr>
                      <td><?= ++$i; ?></td>
                      <td>
                        <button type="button" class="btn btn-sm btn-outline-dark" data-bs-toggle="modal" data-bs-target="#orderProcessModal" data-orderid="<?= $row['order_tbl_id'] ?>">
                          Dispatch Order
                        </button>
...
<div class="modal fade" id="orderProcessModal" tabindex="-1" aria-labelledby="orderProcessModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="<?= base_url('Madmin/dispatch_order') ?>">
