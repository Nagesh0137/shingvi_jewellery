    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <p class="text-muted mb-0 text-truncate">
                                ...
                                +91 <?= $admin_det['admin_mobile_no'] ?>
                            </p>
                            <p class="text-muted mb-0 text-truncate">
                                <i class="ri-mail-line fw-bold lead"></i> <?= $admin_det['admin_email'] ?>
                            </p>
                            <p class="text-muted mb-0">
                                <i class="ri-map-pin-line fw-bold lead"></i>
                                <?= $admin_det['admin_city'] ?>, <?= $admin_det['admin_contry'] ?>
                            </p>
                        </div>
        ...
        <div class="col-xl-8">
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-0">Edit Name, Mobile, Number, Email, City, Password</h6>
                                    </div>
                ...
                <!-- <div class="col-md-4">
                    <a href="<?= base_url() ?>Madmin/edit_admin_password">
                        <div class="card mini-stats-wid">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
