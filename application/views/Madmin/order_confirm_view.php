            ...
            <div class="card">
                ...
                <div class="row">
                            ...
                            <table class="table table-sm">
                                <tr style="background-color: pink;">
                                    ...
                                    <th style="font-weight: bold;color: black;font-size: 20px;">
                                        <?=date('d M Y',strtotime($order[0]['date_time']));?>
                                    </th>
                                </tr>
                                <tr style="background-color: skyblue;">
                                    <th style="color: black;font-size: 20px;" width="30%">
                                    ...
                                    <th style="font-weight: bold;color: black;font-size: 20px;">
                                        <?=date('d M Y',strtotime($order[0]['process_date']));?>
                                    </th>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="col-md-12 text-center" style="margin-top: 10px;">
                        <button class="btn btn-primary btn-lg" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#shift_order_modal">SHIFT ORDER IN DISPATCH</button>
...
<form action="<?=base_url();?>Madmin/order_shift_in_dispatch" method="post">
	...
	<div class="modal" id="shift_order_modal">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <!-- Modal Header -->
	      <div class="modal-header">
	        <h4 class="modal-title" style="color: black;">Dispatch Order</h4>
	      ...
	      <div class="modal-body" style="color: black;">
	        ...
	        <input type="text" name="courier_company" placeholder="COURIER COMPANY NAME" class="form-control">
	      </div>
	      <div class="modal-body" style="color: black;padding-top: 0px;">
	        <label>ENTER TRACKING ID.</label>
	        <input type="text" name="tracking_id" placeholder="ENTER TRACKING ID." class="form-control" required="" minlength="3">
	      </div>

	      <!-- Modal footer -->
	      <div class="modal-footer">
	        <button class="btn btn-primary" >OUT FOR DELIVER / DISPATCH ORDER</button>
	      </div>
