                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="ckeditor" class="form-control" name="delivery_cycle_description" id="formrow-password-input" required placeholder="Delivery Cycle Description"><?= $delivery_data[0]['delivery_cycle_description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="<?= base_url() ?>Madmin/save_delivery_cycle_details" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="formrow-password-input" class="form-label">Delivery Cycle Description</label>
                                        <textarea id="ckeditor" class="form-control" name="delivery_cycle_description" id="formrow-password-input" required placeholder="Delivery Cycle Description"></textarea>
                                    </div>
                                </div>
                            </div>
