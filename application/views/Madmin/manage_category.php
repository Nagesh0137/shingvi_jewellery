                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="ckeditor" name="category_details" rows="5" placeholder="Enter Category Description" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div>
                                                                            ...
                                                                            <div class="card-body">
                                                                                <form action="<?= base_url() ?>Madmin/update_new_category" method="post" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <textarea id="ckeditor" name="category_details" class="form-control" rows="4"><?= br2nl2(nl2br2($row['category_details'])) ?></textarea>
                                                                                    </div>
