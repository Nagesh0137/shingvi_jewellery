...
<div class="container-fluid">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between form-heading p-2 mb-4" style="margin-top:-10px">
            <h4 class="mb-sm-0 font-size-18">Add New Gold + Diamond Product</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url() ?>Madmin/add_gold_diamond_product_save" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-3 mt-2">
                                <label class="form-label">Category:</label>
                                <select name="cat_id" onchange="group_name(this)" id="category_id" class="form-control" required>
                                    <option value="">Category</option>
                                    <?php foreach ($category as $value) {
                                        if (trim($value['category_name']) == 'Diamond') {
                                    ?>
                            ...
                            <div class="col-md-3 d-none">
                                ...
                                <select name="filter_title" class="form-control" onchange="filtername(this)" id="filter_title_id" hidden>
                            ...
                            <div class="col-md-3 d-none">
                                ...
                                <select name="filter_name" class="form-control" id="filter_name_id" hidden>
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <select name="billing_type" class="form-control" onchange="billingtype(this)" id="billing_type" required>
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <select name="caret" class="form-control" onchange="caretratefecth(this)" id="caret" required>
                                    ...
                                    <option value="ct24">24 Ct(99.5%)</option>
                                    <option value="ct22">22 Ct(97%)</option>
                                    <option value="ct18">18 Ct(87%)</option>
                                    <option value="ctpure">Pure Gold(99.9%)</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <textarea id="ckeditor" name="product_details" placeholder="Enter Product Details" class="form-control" rows="2"></textarea>
                            </div>
                            <div class="col-md-6 mt-2">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-12 p-0 m-0">
                                            <input type="text" name="gold_rate" id="gold_rate_fetch" class="bg-warning disabled chartinput" readonly>
                                    ...
                                    <div class="col-md-12" style="border:1px solid black;padding:20px 10px 20px 10px;">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <select name="stone_type1" id="stone_type" class="chartinput">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="stone_shape1" id="stone_shape" class="chartinput">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="col-md-12 p-0 m-0">
                                                    <select class="w-100 pt-1 pb-1" name="stone_color1" id="stone_color" onchange="stonerate();">
                            ...
                            <div class="col-md-12 mt-3" id="fixedbilling" style="border-right: 1px solid black;border-left: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 15px;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="">Todays Rate</label>
                                        <div class="col-md-12 p-0 m-0">
                                            <input type="text" name="gold_rate1" id="gold_rate_fetch1" class="bg-warning disabled chartinput" readonly>
                                            <span class="chartspan">₹</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
