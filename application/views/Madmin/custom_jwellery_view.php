                    ...
                    <li>
                        <div class="d-flex">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="text-muted fs-14 mb-0"><?= !empty($value['phone_number']) ? $value['phone_number'] : 'N/A'; ?></p>
                            </div>
                        </div>
                    </li>
                    <li class="mt-3">
                        <div class="d-flex">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="text-muted fs-14 mb-0"><?= !empty($value['email']) ? $value['email'] : 'N/A'; ?></p>
                            </div>
                        </div>
                    </li>
                    <li class="mt-3">
                        <div class="d-flex">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="text-muted fs-14 mb-0"><?= !empty($value['address']) ? $value['address'] : 'N/A'; ?></p>
                            </div>
                        </div>
                    </li>
                    <?php } ?>
    ...
    <div class="card">
            <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <?php foreach ($custom_jwellery as $value) { ?>
                            <tr>
                                ...
                                <td scope="col"><?= !empty($value['budget']) ? $value['budget'] : 'N/A'; ?> &#8377;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?= !empty($value['diamond_clarity']) ? $value['diamond_clarity'] : 'N/A'; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                ?>
                                    <img class="rounded me-2" alt="200x200" width="200" src="<?= $iimg; ?>" data-holder-rendered="true">
                                <?php } else { ?>
                                    <p>N/A</p>
                                <?php } ?>
                                </td>
                ...
                <div class="hstack gap-2">
                        <a href="<?= base_url(); ?>Madmin/custom_jwellery_progress/<?= $value['custom_jwellery_id']; ?>" class="btn btn-soft-primary w-100">
                        Progress
                        </a>
                        <a href="<?= base_url(); ?>Madmin/custom_jwellery_cancel/<?= $value['custom_jwellery_id']; ?>" class="btn btn-soft-danger w-100" onclick="return confirm('Are You Sure...')">
                            Cancel
                        </a>
                </div>
            </div>
