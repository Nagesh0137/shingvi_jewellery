...
<div class="container-fluid bg-white p-2">
		...
		$gold_rate=$this->db->query("SELECT rate_gold_id,".$value['caret']." from rate_gold order by rate_gold_id DESC")->result_array()[0];
	...
	<div class="row" >
		...
		<div class="col-md-4">
			<?php 
			$metal_amt=($gold_rate[$value['caret']]/10)*$value['net_weight'];
