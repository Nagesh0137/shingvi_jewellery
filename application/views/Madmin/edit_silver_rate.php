<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?=base_url()?>Madmin/silver_rate_update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="silver_amt" id="silver_amt1" placeholder="Todays Price" required  class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?= $silver_data[0]['silver_amt'] ?>" >
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="ratedate" id="ratedate1" required class="form-control" value="<?= $silver_data[0]['ratedate'] ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="formrow-password-input" class="form-label">Enter Todays Rate Time</label>
                                    <input type="time" name="ratetime" id="ratetime1"  required class="form-control" value="<?= $silver_data[0]['ratetime'] ?>">
                                </div>
                            </div>
                        </div>
