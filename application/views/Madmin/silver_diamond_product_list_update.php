                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <select name="cat_id" onchange="group_name(this)" id="category_id" class="form-select" required>
                                    ...
                                    ?>
                                            <option value="<?= $value['category_id']; ?>" <?= $value['category_id'] == $silver_product_details[0]['cat_id'] ? 'selected' : '' ?>><?= $value['category_name']; ?></option>
                                    <?php }
                                    } ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <select name="billing_type" class="form-select" onchange="billingtype(this)" id="billing_type" required>
                                    ...
                                    <option value="manual" <?= $silver_product_details[0]['billing_type'] == 'manual' ? 'selected' : '' ?>>Manual</option>
                                    <option value="fixed" <?= $silver_product_details[0]['billing_type'] == 'fixed' ? 'selected' : '' ?>>Fixed</option>
                                </select>
                            </div>
                            <div class="col-md-3 mt-2">
                                ...
                                <select name="purity" class="form-select" onchange="silverratefecth(this)" id="purity" required>
                                    ...
                                    <option value="50" <?= $silver_product_details[0]['purity'] == '50' ? 'selected' : '' ?>>50 %</option>
                                    <option value="70" <?= $silver_product_details[0]['purity'] == '70' ? 'selected' : '' ?>>70 %</option>
                                    <option value="85" <?= $silver_product_details[0]['purity'] == '85' ? 'selected' : '' ?>>85 %</option>
                                    <option value="92.5" <?= $silver_product_details[0]['purity'] == '92.5' ? 'selected' : '' ?>>92.5 %</option>
                                    <option value="100" <?= $silver_product_details[0]['purity'] == '100' ? 'selected' : '' ?>>100 %</option>
                                </select>
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Product ID</label>
                                <input type="text" name="product_id" required class="form-control" placeholder="Enter Product ID..." value="<?= $silver_product_details[0]['product_id'] ?>">
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Enter Product name</label>
                                <input type="text" name="product_name" required class="form-control" placeholder="Enter Product name" value="<?= $silver_product_details[0]['product_name'] ?>">
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Available Qty</label>
                                <input type="number" name="product_qty" required class="form-control" placeholder="Enter Product ID..." value="<?= $silver_product_details[0]['product_qty'] ?>">
                            </div>
                            <div class="col-md-6 mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered">
                                                ...
                                                <?php
                                                $images = explode('||', $silver_product_details[0]['product_image']);
                                                foreach ($images as $image) {
                                                    $pro_image = FCPATH . "uploads/" . $image;
                                                    if (!empty($pro_image) && file_exists($pro_image)) {
                                                ?>
                                                        <tr>
                                                            <td><img src="<?= base_url('uploads/') . $image ?>" alt
                                                                    style="width: 50px; height: 50px;"></td>
                                                            <td><button type="button" class="btn btn-danger" onclick="deleteimage(<?= $silver_product_details[0]['prod_gold_id'] ?>,`<?= $image ?>`)">Delete</button></td>
                                                        </tr>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <tr>
                                                            <td class="text-center" colspan="20">No Image Found</td>
                                                        </tr>
                                                <?php
                                                    }
                                                }
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <textarea id="ckeditor" name="product_details" class="form-control" rows="2"><?= $silver_product_details[0]['product_details'] ?></textarea>
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Ref. Product</label>
                                <input type="text" name="product_ref" required class="form-control" placeholder="Enter Product Ref." value="<?= isset($silver_product_details[0]['product_ref']) ? $silver_product_details[0]['product_ref'] : '' ?>">
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Certificate No</label>
                                <input type="text" name="certificate_no" required class="form-control" value="<?= isset($silver_product_details[0]['certificate_no']) ? $silver_product_details[0]['certificate_no'] : '' ?>" placeholder="Enter Certificate No">
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Style No</label>
                                <input type="text" name="style_no" required class="form-control" placeholder="Enter Style No" value="<?= isset($silver_product_details[0]['style_no']) ? $silver_product_details[0]['style_no'] : '' ?>">
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Vendor Size</label>
                                <input type="text" name="vendor_size" value="<?= isset($silver_product_details[0]['vendor_size']) ? $silver_product_details[0]['vendor_size'] : '' ?>" required class="form-control" placeholder="Enter Vendor Size">
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Design</label>
                                <input type="text" name="design" value="<?= isset($silver_product_details[0]['design']) ? $silver_product_details[0]['design'] : '' ?>" required class="form-control" placeholder="Enter Design">
                            </div>
                        </div>
                        <?php
                        // echo "<pre>";
                        // print_r($silver_product_details);
                        ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-12 p-0 m-0">
                                            <input type="text" name="silver_rate" id="silver_rate_fetch" class="bg-danger disabled chartinput" value="<?= $silver_product_details[0]['silver_rate'] ?>" readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-12 p-0 m-0">
                                            <input type="text" name="cross_weight" onkeyup="net_weight_check()" id="cross_weight" class="chartinput" value="0" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?= $silver_product_details[0]['cross_weight'] ?>">
...
<style type="text/css">
    #ratechart {
        display: <?= $silver_product_details[0]['billing_type'] == 'manual' ? 'block' : 'none' ?>;
    }

    #fixedbilling {
        display: <?= $silver_product_details[0]['billing_type'] == 'fixed' ? 'block' : 'none' ?>
    }
</style>
<style type="text/css">
    .chartspan {
    ...
    function addstonedetails() {
        ...
        if ((stone_pcs1 == null || stone_pcs1 == 0) && (stone_caret1 == null || stone_caret1 == 0) && (wt_gms1 == null || wt_gms1 == 0) && (stone_amt1 == null || stone_amt1 == 0)) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    stone_type: stone_type1,
                    stone_shape: stone_shape1,
                    stone_color: stone_color1,
                    stone_clarity: stone_clarity1
                },
                dataType: 'json'
            }).done(function(res) {
...
<script type="text/javascript">
    function group_name(cat) {
        $.ajax({
            ...
            var product_group_id = `<?= $silver_product_details[0]['group_id'] ?>`; // Preselected group ID
            console.log(product_group_id);

            // Build the dropdown options
            var opt = "<option value=''>Choose Group</option>";
            $.each(res, function(key, val) {
                var selected = (val.product_group_id == product_group_id) ? "selected" : ""; // Check if it matches
                opt += "<option value='" + val.product_group_id + "' " + selected + ">" + val.product_group_name + "</option>";
            });

            // Update the group_id dropdown
            $("#group_id").html(opt);
        });
    }

    // Automatically fetch groups for the pre-selected category on page load
    $(document).ready(function() {
        var selectedCategory = $("#category_id").val(); // Get the currently selected category
        if (selectedCategory) {
            group_name({
...
<script type="text/javascript">
    ...
    //         dataType : 'json'
    //         }).done(function(res){
    //             var product_group_id=`<?= $silver_product_details[0]['group_id'] ?>`
    //             console.log(product_group_id);
    //         	var opt="<option value=''>Choose Group</option>";
    //         	$.each(res, function(key,val){
...
<script>
    //  function deleteimage(product_gold_id,product_image){
    //     console.log(product_gold_id +" "+product_image);
    // }
    function deleteimage(pr_id, img_name) {
        $.ajax({
