                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="ckeditor" name="blog_details" class="form-control" rows="<?= isset($blog_det[0]) ? '5' : '8' ?>" placeholder="Enter Blog Description"><?= (isset($blog_det[0]['blog_details'])) ? $blog_det[0]['blog_details'] : '' ?></textarea>
                                        </div>
