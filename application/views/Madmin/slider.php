    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between form-heading p-2 mb-4" style="margin-top:-10px">
                <h4 class="mb-sm-0 font-size-18"><?= (isset($slider_det[0])) ? 'Update Slider Image (660 x 780)' : 'Manage Slider Images' ?></h4>
            </div>
        </div>
        <?php
                            ...
                            function processImage(event) {
                                ...
                                reader.onload = function(e) {
                                    ...
                                    img.onload = function() {
                                        ...
                                        // **Set Fixed Dimensions to 660x780**
                                        let width = 660;
                                        let height = 780;
                                        ...
                                        canvas.toBlob(function(blob) {
                                            ...
                                            errorMessage.textContent = "Image resized to 660x780 without quality loss!";
                        ...
                        <script>
                            function checkImageSize() {
                                ...
                                if (file) {
                                    const img = new Image();
                                    img.onload = function() {
                                        if (img.width !== 660 || img.height !== 780) {
                                            errorMessage.textContent = 'Image must be exactly 660px x 780px.';
                    ...
                    reader.onload = function(e) {
                        ...
                        img.onload = function() {
                            ...
                            canvas.toBlob(function(blob) {
                                ...
                                errorMessage.textContent = "Image resized to 660x780 and compressed successfully!";
                                errorMessage.style.color = "green";
