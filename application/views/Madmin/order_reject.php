<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url() ?>Madmin/order_reject" method="get">
                        <div class="col-sm-12">
                        ...
                        <?php $i=$start;if(isset($order) && count($order)>0){ foreach ($order as  $value) { ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?= date('d M Y ',$value['cancel_date']);?></td>
                                    <td><a href="<?=base_url();?>Madmin/order_reject_view?id=<?=$value['user_billing_details_id'];?>"><button class="btn btn-primary"><i class="fa fa-print"></i> View</button></a></td>
                                </tr>
                            </tbody>
                        <?php }}else {?>
                            <tfoot>
                                <tr>
                                    <td colspan="20"><h1 class="text-center text-danger pt-3 pb-2">Currently No Rejected Orders</h1></td>
                                </tr>
                            </tfoot>
                        <?php } ?>
                    </table>
