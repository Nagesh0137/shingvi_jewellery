                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-xxl-12 col-lg-12">
                                    ...
                                    <textarea name="history_desc" id="ckeditor" placeholder="Enter History Description" class="form-control" rows="4" required></textarea>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-bordered text-center dt-responsive nowrap w-100 table-check" id="job-list">
                            <thead>
                                ...
                                <?php $i = 1;
                                foreach ($web_history_details as $value) {
