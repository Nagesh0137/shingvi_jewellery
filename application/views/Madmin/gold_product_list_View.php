					...
					<table class="table table-sm w-100 table-bordered table-striped p-0">
						...
						<tr>
							...
							<td>
								...
								<b><?=$madmin->float_rate_check($price[$value['caret']]/10*$value['net_weight'],3,'.','');?>₹</b>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								...
								<b><?=$madmin->float_rate_check($lammt,3,'.','');?> ₹ (<?=$value['labour_char']." p/g";?>)</b>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								...
								$p=$price[$value['caret']]/10*$value['net_weight'];
								 ...
								 echo $madmin->float_rate_check($mtl,3,'.','');
								 echo "₹";
								?></b>
							</td>
						</tr>
				...
				<div class="row">	
					...
					<div class="col-md-12">
						...
						<tr>
							...
							<td>
								<?php
								 ...
								 echo $madmin->float_rate_check($gst,3,'.','');
								 echo "₹";
								 $nettotal=$tott+$gst;
								 ?>
							</td>
						...
						<tr>
							...
							<td><?php echo $madmin->float_rate_check($nettotal,3,'.',''); ?>₹</td>
						</tr>
					</table>
					</div>
				</div>
