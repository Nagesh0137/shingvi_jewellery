                        ...
                        <form action="<?=base_url()?>Madmin/update_about_details" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-6 col-lg-6">
                                    ...
                                    <textarea name="about_desc" placeholder="Enter About Description" class="form-control" rows="4" required><?= $about_data[0]['about_desc'] ?></textarea>
                                </div>
                        ...
                        <form action="<?=base_url()?>Madmin/about_details_save" method="post" enctype="multipart/form-data" id="form1">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="col-xxl-12 col-lg-12">
                                        <label for="about_desc" class="form-label">About Description</label>
                                        <textarea name="about_desc" placeholder="Enter About Description" class="form-control" rows="4" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 text-center">
