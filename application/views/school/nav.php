    <div class="startbar d-print-none">
        ...
        <div class="brand">
            <a href="index.html" class="logo">
                <span>
                    <img src="<?=base_url()?>assets/logo.png" alt="logo-small" class="logo-lg border border-light w-100" style="height: 80px;object-fit: cover;" >
                </span>
                <span class="">
                    <!-- <img src="<?=base_url()?>assets/logo.png" style="max-width: 140px;" alt="logo-large" class="logo-lg logo-light"> -->
                    <!-- <img src="<?=base_url()?>assets/logo.png" style="max-width: 140px;" alt="logo-large" class="logo-lg logo-dark"> -->
                </span>
            </a>
        </div>
        <!--end brand-->
                    ...
                    <ul class="navbar-nav mb-auto w-100">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarElements">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?=base_url()?>school/teachers">Add Teacher</a>
                                    </li><!--end nav-item--> 
                                    <li class="nav-item">
