...
<!-- Mirrored from mannatthemes.com/rizz/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Aug 2024 14:10:32 GMT -->
<head>
    

    <meta charset="utf-8" />
            <title>Manali D | Manali D - School Dashboard Template</title>
            ...
            <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
                ...
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                    ...
                    <li class="mx-3 welcome-text">
                        <h3 class="mb-0 fw-bold text-truncate c"><?=$school_det[0]['SchoolName']?></h3>
                ...
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                    ...
                    <li class="dropdown">
                        ...
                        <img src="<?=base_url()?>assets/Flag_of_India.png" alt="" class="thumb-sm rounded-circle">
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><img src="<?=base_url()?>assets/Flag_of_India.png" alt="" height="15" class="me-2">English</a>
                            <a class="dropdown-item" href="#"><img src="<?=base_url()?>assets/Flag_of_India.png" alt="" height="15" class="me-2">Marathi</a>
                            <a class="dropdown-item" href="#"><img src="<?=base_url()?>assets/Flag_of_India.png" alt="" height="15" class="me-2">Hindi</a>
                        </div>
                    ...
                    <li class="dropdown topbar-item">
                        <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                            aria-haspopup="false" aria-expanded="false">
                            <img src="<?=base_url()?>assets/images/users/avatar-1.jpg" alt="" class="thumb-lg rounded-circle">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end py-0">
                            ...
                            <a class="dropdown-item text-danger" href="<?=base_url()?>school/logout"><i class="las la-power-off fs-18 me-1 align-text-bottom"></i> Logout</a>
                        </div>
                    </li>
                </ul><!--end topbar-nav-->
            </nav>
