    ...
    <?php foreach ($product as $value) {
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url(); ?>admin/gold_product_list_update_information" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <select name="caret" class="form-control" onchange="caretratefecth(this)" id="caret"
                                        required>
                                        ...
                                        <option value="ctpure" <?php if ($value['caret'] == "ctpure") {
                                            echo "selected";
                                        } ?>>Pure
                                            Gold</option>
                                    </select>
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="number" name="product_id" value="<?= $value['product_id']; ?>"
                                        class="form-control">
                                </div>
                                <div class="col-md-6 mt-2">
                        ...
                        <form action="<?= base_url(); ?>admin/gold_product_list_update_images" method="post"
                            enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <div class="row">
                                        <div class="col-md-12 mt-2" style="border-top:2px solid black;">
                                            <h4 class="font-weight-bold text-primary text-uppercase my-2">All Product Images
                                            </h4>
                                            <input type="hidden" name="prod_gold_id" value="<?= $value['prod_gold_id']; ?>">
                                        </div>
                                        <?php
                                                ...
                                                if (!empty($image) && file_exists($image_path)) {
                                                    ...
                                                    <div class="col-md-3 mt-2 border m-3 p-2 shadow">
                                                        <button class="btn btn-danger btn-sm" type="button"
                                                            onclick="deleteimg(<?= $value['prod_gold_id']; ?>, '<?= $image ?>')">
                        ...
                        <form action="<?= base_url(); ?>admin/gold_product_list_update_new_images" method="post"
                            enctype="multipart/form-data">
                            <div class="row"
                                style="border-bottom:2px solid black;border-top:2px solid black; padding:10px 0px 10px 0px;margin-top:10px;">
                                <div class="col-md-12 mt-2">
                                    <h4 class="font-weight-bold text-primary text-uppercase">Add New Images <span
                        ...
                        <div class="row">
                            ...
                            <?php if ($value['billing_type'] == "manual") { ?>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mt-3"
                                    ...
                                    <form action="<?= base_url(); ?>admin/gold_product_list_update_billing" method="post"
                                        enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12 p-0 m-0">
                                                    ...
                                                    <input type="text" name="gold_rate" id="gold_rate_fetch"
                                                        class="bg-danger disabled chartinput"
                                                        value="<?= $price[$value['caret']]; ?>" readonly>
                                                    ...
                                                    <tbody id="add_tbody">
                                                        ...
                                                        foreach ($product_gold_other_price_det as $value1) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if ($ooii == 0) { ?>
                                                                        <button type="button" onclick="add_row()"><i
                                                                                class="fa fa-plus"></i></button>
                                                                        <?php $ooii++;
                                                                    } ?>
                                                                    <button type="button"
                                                                        onclick="delete_other_row(<?= $value1['product_gold_other_price_det_id']; ?>,<?= $value1['product_gold_id']; ?>)"><i
                        ...
                        <?php } ?>
                        <div class="col-12 col-sm-12 col-md-6 mt-3 table-responsive"
                            style="border-right: 1px solid black;border-left: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 15px;padding-bottom:15px;">
                            ...
                            <div class="table-reponsive">
                                <table class="table table-warning  text-center table-striped table-bordered ">
                                    ...
                                    <?php foreach ($filter as $value) {
                                        ...
                                        ?>
                                        <tr>
                                            <td><?= isset($product_group[0]['product_group_name']) ? $product_group[0]['product_group_name'] : 'N/A' ?>
                                            </td>
                                            <td><?= isset($filter_title[0]['filter_title']) ? $filter_title[0]['filter_title'] : 'N/A' ?>
                                            </td>
                                            <td><?= isset($filter_name[0]['filter_name']) ? $filter_name[0]['filter_name'] : 'N/A' ?>
                                            </td>
...
<script type="text/javascript">
    function caretratefecth(caret) {
        ...
        if (caret1 == "") {
            ...
            $.ajax({
                url: "<?= base_url() ?>admin/caretratefecth",
                type: 'POST',
    ...
    function delete_other_row(other_id, prod_id) {
        if (confirm("Are Your Sure Delete Other Amount Row...")) {
            $.ajax({
                url: "<?= base_url() ?>admin/gold_product_list_update_del_other",
                type: 'POST',
