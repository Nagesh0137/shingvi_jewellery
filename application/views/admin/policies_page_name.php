<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <form action="<?=base_url()?>admin/pages_name_save" method="post" enctype="multipart/form-data" id="form1">
                        <div class="row">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <form action="<?=base_url()?>admin/pages_name_update" method="post" enctype="multipart/form-data" id="form2">
                        <div class="row">
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between form-heading p-2 mb-4" style="margin-top:-10px">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered  table-sm text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Are You Sure to permanant Delete this data...')" href="<?=base_url();?>admin/pages_name_delete/<?=$value['pages_name_id'];?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                    ...
                                    <a href="<?=base_url();?>admin/pages_name_view/<?=$value['pages_name_id'];?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
