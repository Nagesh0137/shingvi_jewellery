                                ...
                                if (count($custom_jwellery) > 0) {
                                    ...
                                    foreach ($custom_jwellery as $row) {
                                        ...
                                        <tr>
                                            <td>
                                                <a
                                                    href="<?= base_url() ?>admin/custom_jwellery_progress_confirm/<?= $row['custom_jwellery_id'] ?>"><button
                                                        class="btn btn-success btn-block btn-sm ">Confirm</button></a>
                                                <a
                                                    href="<?= base_url() ?>admin/custom_jwellery_progress_cancel/<?= $row['custom_jwellery_id'] ?>"><button
                                                        class="btn btn-danger btn-block btn-sm"
                                                        onclick="return Confirm('Are You Sure');">Cancel</button></a>
                                            </td>
                                            <td><?= ++$i ?></td>
