<div class="container">
    <?php if (isset($disclaimer_policy_det[0])) { ?>
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>admin/update_disclaimer_policy"
                            method="post" enctype="multipart/form-data">
                            <div class="row">
                                <input type="hidden" name="disclaimer_policy_tbl_id" value="<?= $disclaimer_policy_det[0]['disclaimer_policy_tbl_id'] ?>">
                                <div class="col-md-4">
                                    <label for="formrow-firstname-input" class="form-label">Enter Disclaimer Name</label>
                                    <input type="text" name="disclaimer_name" class="form-control"
                                        placeholder="Enter Disclaimer Name" value="<?= $disclaimer_policy_det[0]['disclaimer_name'] ?>" required>
                                </div>
    ...
    <?php } else { ?>
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>admin/save_disclaimer" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="formrow-firstname-input" class="form-label">Enter Disclaimer Name</label>
                                    <input type="text" name="disclaimer_name" class="form-control"
                                        placeholder="Enter Disclaimer Name" required>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table text-center table-bordered mb-0">
                                ...
                                <tbody>
                                    <?php
                                    if (isset($disclaimer_policy) && count($disclaimer_policy) > 0) {
                                        foreach ($disclaimer_policy as $key => $row) {
                                    ?>
                                            <tr>
                                                <td><?= ++$key ?></td>
                                                <td class="d-flex">

                                                    <a href="<?= base_url() ?>admin/edit_disclaimer_policy/<?= $row['disclaimer_policy_tbl_id'] ?>"
                                                        class="btn btn-info btn-sm p-0 m-0 pb-0" style="height:3vh;width:3vh">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a href="<?= base_url() ?>admin/delete_disclaimer_policy/<?= $row['disclaimer_policy_tbl_id'] ?>"
                                                ...
                                                <td><?= $row['disclaimer_name'] ?></td>
                                                <td><?= $row['disclaimer_details'] ?></td>
                                            </tr>
                                        <?php
                                        }
                                    } else {
