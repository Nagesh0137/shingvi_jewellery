...
<!-- <div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/gold_product_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/silver_product_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-product-hunt"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/gold_diamond_product_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-product-hunt"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/order_pending">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/order_Confirm">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-cart"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/order_dispatch">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-cart"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/order_delivered">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-cart"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/order_reject">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-cart"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/custom_jwellery">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/custom_jwellery_progress_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-bag"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/custom_jwellery_confirm_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-bag"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/custom_jwellery_cancel_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
                            <span><i class="fa fa-shopping-bag"></i></span>
        ...
        <div class="col-md-3 col-sm-6 mt-2 rot">
            <a href="<?= base_url() ?>jadmin/customer_list">
                <div class="serviceBox">
                    <div class="service-content">
                        <div class="service-icon">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-md-3">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Todays Rate <span
                            class="text-primary fw-bold"><?= date("d M Y") ?></span></h4>
                    <div class="mt-4">
                            ...
                            <table class="table table-nowrap align-middle table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);"
                                                    class="text-dark">Gold 24CT</a></h5>
                                            <p class="text-muted mb-0">Gold 24CT/10g : <b> &#8377;
                                                    <?= number_format($gold_rate[0]['ct24']) ?> /-</b></p>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);"
                                                    class="text-dark">GOLD 22CT</a></h5>
                                            <p class="text-muted mb-0">GOLD 22CT/10g : <b> &#8377;
                                                    <?= number_format($gold_rate[0]['ct22']) ?>/-</b></p>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);"
                                                    class="text-dark">GOLD 18CT</a></h5>
                                            <p class="text-muted mb-0">GOLD 18CT/10g : <b> &#8377;
                                                    <?= number_format($gold_rate[0]['ct18']) ?>/- </b></p>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);"
                                                    class="text-dark">Silver Rate</a></h5>
                                            <p class="text-muted mb-0">SILVER/10g : <b> &#8377;
                                                    <?= number_format($silver_rate[0]['silver_amt']) ?>/-</b> </p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <table class="table align-middle mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div id="radialchart-1" data-colors='["--bs-primary"]' class="apex-charts">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="radialchart-2" data-colors='["--bs-success"]' class="apex-charts">
                                        </div>
                                    </td>
                                    <td>
                                        <p class="text-muted mb-1">Qty</p>
        ...
        <div class="col-xl-5">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="<?= base_url() ?>admin/gold_product_list">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-xs me-3">
                ...
                <div class="col-sm-6">
                    <a href="<?= base_url() ?>admin/silver_product_list">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-xs me-3">
                                        <span
                                            class="avatar-title rounded-circle bg-dark text-success fw-bold font-size-18">
                                            <i class="bx bx-gift"></i>
                                        </span>
                                    </div>
                ...
                <div class="col-sm-6">
                    <a href="<?= base_url() ?>admin/gold_diamond_product_list">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-xs me-3">
                                        <span
                                            class="avatar-title rounded-circle bg-dark text-success font-size-18 fw-bold">
                                            <i class="bx bx-gift"></i>
                                        </span>
                                    </div>
                ...
                <div class="col-sm-6">
                    <a href="<?= base_url() ?>admin/order_pending">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-xs me-3">
                                        <span
                                            class="avatar-title rounded-circle bg-dark text-info fw-bold font-size-18">
    ...
    <div class="row">
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/order_Confirm">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/order_confirm_paid">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
                            ...
                            <h5 class="font-size-14 mb-0">Total Confirm & Paid Order</h5>
                        </div>
                        <div class="text-muted mt-4">
                            <h4><?= $dashboard['confirm_order']; ?></h4>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/order_dispatch">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/order_delivered">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/order_reject">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/custom_jwellery">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/custom_jwellery_progress_list">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/custom_jwellery_confirm_list">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
        ...
        <div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
            <a href="<?= base_url() ?>admin/custom_jwellery_cancel_list">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs me-3">
