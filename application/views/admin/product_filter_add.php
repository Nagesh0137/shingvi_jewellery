<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url() ?>admin/product_filter_add_search" method="get"
                        enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Category</label>
                                <select name="cat_id" onchange="group_name1(this)" id="cat_id" class="form-select"
                                    required>
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <select name="group_id" onchange="filter_title1(this)" class="form-select"
                                    id="group_list" required>
                                    <option value="">Group List</option>
                                </select>
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Filter Title</label>
                                <select name="filter_tit_id" onchange="filter_name1(this)" class="form-select"
                                    id="filter_tit_id1" required>
                                                ...
                                                <td>
                                                    <?php if (isset($filter[0]['filter_id'])) { ?>
                                                        <button class="btn btn-danger btn-sm"
                                                            onclick="apply_filter_on_product(<?= $cat_id ?>,<?= $group_id ?>,<?= $value['prod_gold_id'] ?>,<?= $filter_tit_id ?>,<?= $filter_name_id ?>,this)"><i
        ...
        <?php } else {
            ...
            <div class="col-lg-6 ">
                <div class="card card-body text-center">
                    ...
                    <p class="card-text">Refine your selection by applying <br> filters or reset them to view all available
                        gold products.</p>
...
<script type="text/javascript">
    function filter_title1(group) {
        ...
        $.ajax({
            url: "<?= base_url() ?>admin/filte_title_fetch",
            type: 'POST',
...
<script type="text/javascript">
    function filter_name1(tit) {
        ...
        $.ajax({
            url: "<?= base_url() ?>admin/prod_filter_name_fetch",
            type: 'POST',
    ...
    function apply_filter_on_product(cat_id, group_id, prod_id, ftid, fnid, elmt) {
        $.ajax({
            url: "<?= base_url() ?>admin/apply_filter_on_product",
            type: 'POST',
