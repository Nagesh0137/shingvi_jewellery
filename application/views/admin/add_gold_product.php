<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<form action="<?= base_url() ?>admin/add_new_gold_product" method="post"
							...
							<div class="col-md-7 mt-4">
								<div class="row">
									...
									<div class="col-md-12 mt-4">
										...
										<textarea id="ckeditor" name="product_details" class="form-control" rows="5"
												...
												<tr>
													...
													<td>
														<button type="button" class="btn btn-primary btn-sm"
															onclick="add_row()"><i class="fa fa-plus"></i></button>
													</td>
												</tr>
											</tbody>
										</table>
									...
									<div class="col-md-6">
										<div class="col-md-12 p-0 m-0">
											<input type="text" name="total_discount_amt" onkeyup="fixed_billing_cal()"
												id="total_discount_amt" class="bg-success">
											<span class="chartspan">₹</span>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6">
										<div class="col-md-12 p-0 m-0">
											<input type="text" name="final_amount_after_discount"
												id="final_amount_after_discount" class="bg-info" value="0" readonly>
											<span class="chartspan">₹</span>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	function filtertitle(group) {
		...
		$.ajax({
			url: "<?= base_url() ?>admin/filter_title_fetch",
			type: 'POST',
			data: {
				cat_id: cat,
	...
	function filtername(title) {
		...
		$.ajax({
			url: "<?= base_url() ?>admin/filter_name_fetch",
			type: 'POST',
			data: {
				cat_id: cat,
				group_id: group_id1,
