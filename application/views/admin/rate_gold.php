<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url() ?>admin/gold_rate_add" method="post" enctype="multipart/form-data"
                        id="form1">
                        <div class="mb-3">
                            <label for="formrow-firstname-input" class="form-label">Enter Todays Rate</label>
                            <input type="text" name="rateamt" id="rateamt" onkeyup="ratecal(this.value)"
                                placeholder="Todays Price" required class="form-control"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ct24" id="ct24" placeholder="24 CT(99.5%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ct22" id="ct22" placeholder="22 CT(94%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ct18" id="ct18" placeholder="18 CT(81%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ctpure" id="ctpure" placeholder="Pure Gold(99.9%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    <form action="<?= base_url() ?>admin/gold_rate_update" method="post" enctype="multipart/form-data"
                        id="form2">
                        <div class="mb-3">
                            <label for="formrow-firstname-input" class="form-label">Enter Todays Rate</label>
                            <input type="text" name="rateamt" id="rateamt1" onkeyup="ratecal1(this.value)"
                                placeholder="Todays Price" required class="form-control"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="formrow-email-input" class="form-label">Enter Todays Rate Date</label>
                                    <input type="hidden" name="rate_gold_id" id="rate_gold_id1" required
                                        class="form-control">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="formrow-inputCity" class="form-label">24 CT(99.5%)</label>
                                    <input type="text" name="ct24" id="ct241" placeholder="24 CT(99.5%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="formrow-inputCity" class="form-label">22 CT(94%)</label>
                                    <input type="text" name="ct22" id="ct221" placeholder="22 CT(94%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="formrow-inputZip" class="form-label">18 CT(81%)</label>
                                    <input type="text" name="ct18" id="ct181" placeholder="18 CT(81%)" required
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="formrow-inputZip" class="form-label">Pure Gold(99.9%)</label>
                                    <input type="text" name="ctpure" id="ctpure1" placeholder="Pure Gold(99.9%)"
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <form style="border-bottom:1px solid black;" action="<?= base_url() ?>admin/gold_rate_search"
                        method="get" enctype="multipart/form-data" class="d-flex align-items-center">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-outline-primary btn-sm"
                                                onclick="updategold('<?= $value['rate_gold_id']; ?>','<?= $value['ratedate']; ?>','<?= $value['ratetime']; ?>','<?= $value['ct24']; ?>','<?= $value['ct22']; ?>','<?= $value['ct18']; ?>','<?= $value['ctpure']; ?>','<?php if (isset($search['from_date'])) {
                                            ...
                                            <a onclick="return confirm('Are You Sure to permanant Delete this data...')"
                                                href="<?= base_url(); ?>admin/gold_rate_delete/<?= $value['rate_gold_id']; ?><?php if (isset($search['from_date'])) {
                                                    echo "/" . $search['from_date'];
                                                } ?><?php if (isset($search['to_date'])) {
                                                    echo "/" . $search['to_date'];
                                                } ?>"
