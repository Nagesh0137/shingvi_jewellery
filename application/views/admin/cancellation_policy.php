<div class="container">
    <?php if (isset($cancellation_policy_det[0])) { ?>
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>admin/update_cancellation_policy"
                            method="post" enctype="multipart/form-data">
                            <div class="row">
                                <input type="hidden" name="cancellation_policy_tbl_id" value="<?= $cancellation_policy_det[0]['cancellation_policy_tbl_id'] ?>">
                                <div class="col-md-4">
                                    <label for="formrow-firstname-input" class="form-label">Enter Cancellation Name</label>
                                    <input type="text" name="cancellation_name" class="form-control"
                                        placeholder="Enter Cancellation Name" value="<?= $cancellation_policy_det[0]['cancellation_name'] ?>" required>
                                </div>
    ...
    <?php } else { ?>
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>admin/save_cancellation" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="formrow-firstname-input" class="form-label">Enter Cancellation Name</label>
                                    <input type="text" name="cancellation_name" class="form-control"
                                        placeholder="Enter Cancellation Name" required>
                                </div>
                            ...
                            <table class="table text-center table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    if (isset($cancellation_policy) && count($cancellation_policy) > 0) {
                                        foreach ($cancellation_policy as $key => $row) {
                                    ?>
                                            <tr>
                                                <td><?= ++$key ?></td>
                                                <td class="d-flex">
                                                    ...
                                                    <a href="<?= base_url() ?>admin/edit_cancellation_policy/<?= $row['cancellation_policy_tbl_id'] ?>"
                                                        class="btn btn-info btn-sm p-0 m-0 pb-0" style="height:3vh;width:3vh">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a href="<?= base_url() ?>admin/delete_cancellation_policy/<?= $row['cancellation_policy_tbl_id'] ?>"
                                                ...
                                                <td><?= $row['cancellation_name'] ?></td>
                                                <td><?= $row['cancellation_details'] ?></td>
                                            </tr>
                                        <?php
                                        }
                                    } else {
