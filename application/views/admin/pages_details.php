            ...
            <div class="card">
                <div class="card-body">
                    <!-- Add Details Form -->
                         ...
                         <form action="<?= base_url() ?>admin/pages_details_save" method="post" enctype="multipart/form-data" id="form1">
                        <div class="row">
                            <div class="col-12">
                    ...
                    <form action="<?= base_url() ?>admin/pages_details_update" method="post" enctype="multipart/form-data" id="form2">
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between form-heading p-2 mb-4" style="margin-top:-10px">
                        ...
                        <table class="table table-bordered text-center table-hover table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="<?= base_url(); ?>admin/pages_details_delete/<?= $value['page_details_id']; ?>" 
