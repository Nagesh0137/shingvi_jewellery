...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2025 at 06:19 AM
...
(0, '', NULL, NULL, NULL, '9595038373', NULL, '', '', NULL, '', '', '1752905574', 'active', NULL),
...
(11, 'Nilesh Borkar', 'Nilesh', 'Borkar', 'nilbor407@gmail.com', '9503077104', NULL, '', '', NULL, '', '', '1742453902', 'active', 'https://lh3.googleusercontent.com/a/ACg8ocJTf-bDWesaPbUcO3m55K3nPRhtr0xTr09a70wQu2PdLABUNLZeIQ=s96-c'),
...
(35, 'Manali Dhongade', 'Manali', 'Dhongade', 'a2z.d.manali@gmail.com', '9075461110', NULL, 'Savedi', '', NULL, '', '', '1745842205', 'active', NULL),
...
(41, 'dev clients', 'dev', 'clients', 'devs.clients@gmail.com', NULL, NULL, '', '', NULL, '', '', '1752230962', 'active', 'https://lh3.googleusercontent.com/a/ACg8ocL04xUedmLl0KBm9HJ2agi9TLwCbaoZjF-BdF2okniGlQkllw=s96-c');
...
(3, 'FLAT NO 333 Name of Premises/ Building GAGANGIRI DREAMLAND WAKAD Block -  KASPATE VASTI City PUNE CITY', '414003', 'Nagar', 'active', '1752752056', 'user', '35', 'yes'),
...
(119, '5', '9', '', 'ct24', '', 'Bangles', '10', 'Using existing bangles: Measure the inside diameter of a bangle you already own and compare it to the size charts.\r\nMeasuring your hand:\r\nMake your hand as small as possible, as if you were putting on bangles (bringing your thumb and little finger together).\r\nMeasure the widest part of your hand using a flexible tape measure or a strip of paper and a ruler. This is your hand\'s circumference.\r\nCompare this measurement to the bangle circumference in the charts to find the correct size.', '', '', '28683s237', 'manual', '97980', '', '30', '3', '0', '30', '0', '5000', '3', '175256155818969135.webp||175256156032812514.jpg||175256156076553056.jpg', '0', '0', '0', '278467', '250', '278217.00', 'active', '5', '1752561560', '', '', '', 'women', '', '60.30 MM,61.90 MM', '');
...
(117, 'sameerpalve.2019@gmail.com', '1752926944', '2025-07-19', 'user', 'active'),
(118, 'sameerpalve.2019@gmail.com', '1752927050', '2025-07-19', 'user', 'active'),
(119, 'rakesh@gmail.com', '1752927066', '2025-07-19', 'user', 'active'),
(120, 'sagar@gmail.com', '1752927122', '2025-07-19', 'user', 'active'),
(121, '7666479649', '1752928026', '2025-07-19', 'user', 'active');
...
(1, '103', '35', 'active', '1752839420'),
(2, '117', '35', 'active', '1752906073'),
(3, '95', '35', 'active', '1752906082'),
(4, '96', '35', 'active', '1752906086'),
(5, '109', '35', 'active', '1752906142'),
(6, '109', '35', 'active', '1752906155'),
(7, '119', '35', 'active', '1752906434'),
(8, '119', '35', 'active', '1752906445'),
(9, '112', '35', 'active', '1752906516'),
(10, '110', '35', 'active', '1752906663'),
(11, '110', '35', 'active', '1752906681');
...
(1, 'Anjali Mehta', 'It is nice to know that your company takes the time to get to know its customers.Beautiful craftsmanship and elegant designs. I love wearing them at weddings!', '5', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11'),
(2, 'Rahul Joshi', 'I bought a gold ring recently and it fits perfectly. Will shop again!', '5', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11'),
(3, 'Priya Nair', 'Graceful and timeless pieces. I’m very impressed with the packaging too.', '5', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11'),
(4, 'Anjali Mehta', 'Beautiful craftsmanship and elegant designs. I love wearing them at weddings!', '5', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11'),
(5, 'Rohan Deshmukh', 'High-quality jewelry and amazing customer service. Highly recommended!', '4', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11'),
(6, 'Sneha Kapoor', 'Stylish and traditional blend perfectly. Received many compliments!', '5', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11'),
(7, 'Vikram Singh', 'Excellent detailing and shine. Perfect gift for my wife.', '4', 'testimonial-1673409611-25861.png', 'active', '4', '2021-01-11');
...
--
-- Indexes for table `subscriber_customer_details`
--
ALTER TABLE `subscriber_customer_details`
  ADD PRIMARY KEY (`subscriber_customer_details_id`);
...
--
ALTER TABLE `admin_permission`
  MODIFY `admin_permission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;

--
-- AUTO_INCREMENT for table `admin_permission_urls`
--
ALTER TABLE `admin_permission_urls`
  MODIFY `admin_permission_urls_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `custom_jwellery`
  MODIFY `custom_jwellery_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `order_charges_det`
  MODIFY `order_charges_det_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `order_tbl`
--
ALTER TABLE `order_tbl`
  MODIFY `order_tbl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `otp_tbl`
--
ALTER TABLE `otp_tbl`
  MODIFY `otp_tbl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=430;
...
--
-- AUTO_INCREMENT for table `subscriber_customer_details`
--
ALTER TABLE `subscriber_customer_details`
  MODIFY `subscriber_customer_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

--
-- AUTO_INCREMENT for table `system_notification`
--
ALTER TABLE `system_notification`
  MODIFY `system_notification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5636;
...
--
ALTER TABLE `user_cart`
  MODIFY `user_cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `web_testimonial`
  MODIFY `web_testimonial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
